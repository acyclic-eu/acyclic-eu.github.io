---
layout: post
title: "Focus Standups: Goal Over Task"
date: 2026-06-16
tags: [Leader, Coach]
---
...
1. **Critical or security issue?** - Yes: drop everything and fix it now.
2. **Blocker on the priority project?** - Yes: add it to the project flow immediately.
3. **High user impact?** - Yes: place it high in the backlog.
4. **Should we do it at all?** - No: close it ("Won't fix"). Yes: bottom of backlog.
